...
|----------|-------------|
| [GSF CoD Simplified proposal doc.md](planning/GSF%20CoD%20Simplified%20proposal%20doc.md) | Proposal document: program model, rationale, eligibility, review process, governance, and success metrics |

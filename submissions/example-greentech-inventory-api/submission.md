# Example Submission: GreenTech Solutions — Inventory Management API

> **This is an example submission.** It demonstrates what a complete, high-quality
> submission looks like. It follows the structure of the submission email template
> exactly. If approved, this submission is published as-is as the public
> disclosure (with the contact email redacted and a certificate metadata header
> added). An accompanying Impact Framework manifest file
> (`greentech-inventory-api-v3.2.1-sci.yml`) is included and can be run with
> `if-run` to independently verify the calculation.

---

**To:** sci-certification@greensoftware.foundation
**Subject:** SCI Self-Certification Submission — GreenTech Solutions — Inventory Management API
...
**Contact email:** sarah.chen@greentechsolutions.example.com
